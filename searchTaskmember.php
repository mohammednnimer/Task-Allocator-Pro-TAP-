...
header("location: /TableTaskmember.php");
...
<form id="searching" action="searchTaskmember.php" method="POST">
<?php
global $errors;
...
<select name="priority" id="priority" class="searhingtask" aria-valuetext="priority">
