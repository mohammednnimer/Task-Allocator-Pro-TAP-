...
if($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    if(empty($_POST["priority"])&&empty($_POST["status"])&&empty($_POST["duedate"])&&empty($_POST["projectName"])){
        ...
        unset($_SESSION['errors']);
        header("location: /TableTaskleader.php");
...
<form id="searching" action="searchTaskleader.php" method="POST">
<?php
global $errors;
...
<select name="priority" class="searhingtask" id="priority" aria-valuetext="priority">
<option value="" disabled selected>Priority</option>
        ...
        <select name="status"  class="searhingtask" id="status">
